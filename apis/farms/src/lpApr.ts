...
import { AprMap } from '@fathomswap/farms'
...
const BLOCK_SUBGRAPH_ENDPOINT = 'https://api.thegraph.com/subgraphs/name/fathomswap/blocks'
const INFO_SUBGRAPH_ENDPOINT = 'https://bsc.streamingfast.io/subgraphs/name/fathomswap/exchange-v2'
