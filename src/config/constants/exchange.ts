import { ChainId, JSBI, Percent, Token, WNATIVE, WBNB } from '@fathomswap/sdk'
import { BigNumber } from '@ethersproject/bignumber'
import { bscTokens, bscTestnetTokens, USDC, USDT, BUSD } from '@fathomswap/tokens'
...
export const GELATO_HANDLER = 'fathomswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.fathomswap.finance/products/fathomswap-exchange/limit-orders'
