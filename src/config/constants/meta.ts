...
export const DEFAULT_META: PageMeta = {
  title: 'FathomSwap',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by FathomSwap), NFTs, and more, on a platform you can trust.',
  image: 'https://fathomswap.finance/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Fathomswap exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for Fathomswap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Fathomswap exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/fathom-squad': { basePath: true, title: t('Fathom Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('FathomSwap'),
  }
}
