...
import { Box, Button, InjectedModalProps, Skeleton, Text, useToast } from '@fathomswap/uikit'
    ...
    <>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {t('Make sure you have a Fathom Collectible in your wallet and try again!')}
          </Text>
        </>
      )}
