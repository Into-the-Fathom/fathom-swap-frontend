...
import { Skeleton, Table, Td, Th, Flex, ArrowUpIcon, ArrowDownIcon } from '@fathomswap/uikit'
...
interface FathomBunniesTraitsProps {
...
const FathomBunniesTraits: React.FC<React.PropsWithChildren<FathomBunniesTraitsProps>> = ({ collectionAddress }) => {
...
export default FathomBunniesTraits
