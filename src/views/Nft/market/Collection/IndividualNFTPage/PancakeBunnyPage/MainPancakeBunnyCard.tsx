...
import { Flex, Box, Card, CardBody, Text, Button, BinanceIcon, Skeleton, useModal } from '@fathomswap/uikit'
...
interface MainFathomBunnyCardProps {
  cheapestNft: NftToken
  nothingForSaleBunny: NftToken
  onSuccessSale: () => void
}

const MainFathomBunnyCard: React.FC<React.PropsWithChildren<MainFathomBunnyCardProps>> = ({
  cheapestNft,
  nothingForSaleBunny,
  onSuccessSale,
}) => {
...
export default MainFathomBunnyCard
