...
import { useFathomBunnyOnSaleNfts } from '../../../../hooks/useFathomBunnyOnSaleNfts'
...
const ForSaleTableCard: React.FC<React.PropsWithChildren<ForSaleTableCardProps>> = ({
  ...
  const {
    ...
    isLastPage,
    isValidating,
  } = useFathomBunnyOnSaleNfts(bunnyId, nftMetadata, itemsPerPage * 10)
  ...
  return (
    <StyledCard hasManyPages>
      ...
      >
        ...
        <UpdateIndicator isFetchingFathomBunnies={isValidating} />
      </Grid>
