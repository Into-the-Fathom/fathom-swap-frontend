...
import { Box, Button, Flex, Heading, LinkExternal } from '@fathomswap/uikit'
  ...
  return (
    <>
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal href="https://docs.fathomswap.finance/contact-us/nft-market-applications" mx="auto" mt="16px">
