...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@fathomswap/uikit'
  ...
  return (
    <>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = nft.collectionAddress.toLowerCase() === fathomBunniesAddress.toLowerCase()
