import { LinkExternal } from '@fathomswap/uikit'
  ...
  return [
    {
      ...
      description: [
        ...
        t('You can instantly swap your WBNB for BNB with no trading fees on FathomSwap.'),
      ],
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.fathomswap.finance/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by FathomSwap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
        ),
        t(
