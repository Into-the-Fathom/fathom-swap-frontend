...
export const useFathomBunnyOnSaleNfts = (
  bunnyId: string,
  nftMetadata: ApiResponseCollectionTokens,
  itemsPerPage: number,
) => {
  ...
  const {
    ...
    (pageIndex, previousPageData) => {
      ...
      return [bunnyId, direction, pageIndex, 'fathomBunnyOnSaleNfts']
    },
    async (id, sortDirection, page) => {
      ...
      const updatedMarketData = await getNftsUpdatedMarketData(fathomBunniesAddress.toLowerCase(), nftsMarketTokenIds)
