import { Flex, Grid, Text, Button, Link, BinanceIcon, LinkExternal, useModal } from '@fathomswap/uikit'
import { useTranslation } from '@fathomswap/localization'
import { nftsBaseUrl, fathomBunniesAddress } from 'views/Nft/market/constants'
...
const SellStage: React.FC<React.PropsWithChildren<SellStageProps>> = ({
  ...
  const itemPageUrlId =
    nftToSell.collectionAddress.toLowerCase() === fathomBunniesAddress.toLowerCase()
