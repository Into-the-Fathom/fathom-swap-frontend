...
import { Box, Flex, Text, Heading, Link, Image, useMatchBreakpoints } from '@fathomswap/uikit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://docs.fathomswap.finance/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://docs.fathomswap.finance/products/lottery/lottery-guide">
              {t('how to play the FathomSwap lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
