...
import { useTranslation, ContextApi } from '@fathomswap/localization'
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@fathomswap/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version >= 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set FathomSquad NFT as Fathom Profile avatar.'),
          needQualifiedPoints: t('Reach a certain Fathom Profile Points threshold.'),
        }
