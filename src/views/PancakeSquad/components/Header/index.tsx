...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@fathomswap/uikit'
import { useTranslation } from '@fathomswap/localization'
import { useGetCakeBalance } from 'hooks/useTokenBalance'
import useTheme from 'hooks/useTheme'
import { StyledWaveContainer } from 'views/FathomSquad/styles'
import { UserStatusEnum } from 'views/FathomSquad/types'
...
import { FathomSquadHeaderType } from './types'

const DEFAULT_CAKE_COST = 15
const DEFAULT_MAX_TICKETS = 10

const FathomSquadHeader: React.FC<React.PropsWithChildren<FathomSquadHeaderType>> = ({
  userInfos,
  eventInfos,
  account,
  userStatus,
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('FathomSwap’s first official generative NFT collection.')}
      </Text>
...
export default FathomSquadHeader
