import { InstagramIcon, TwitterIcon } from '@fathomswap/uikit'
...
const artistConfigBuilder = ({ t, isDark }: ArtistConfigType) => ({
  ...
  bodyText: [
    ...
    t('Cooking hot fathoms for their big ol’ mission:'),
  ...
  image: { src: `/images/fathomSquad/artist${isDark ? '-dark' : ''}.png`, alt: 'Chef Cecy bio' },
})
