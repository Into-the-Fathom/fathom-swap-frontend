...
import { Box, Button, Card, CardBody, Flex, Step, Stepper, Text } from '@fathomswap/uikit'
import { useTranslation } from '@fathomswap/localization'
import { StyledWaveContainer, LandingBodyWrapper } from 'views/FathomSquad/styles'
    ...
    <StyledEventStepsSectionContainer justifyContent="center" $isDark={isDark}>
      ...
      <StyledWaveContainer bottom="-3px">
        <Flex justifyContent="center">
          <StyledBunniesSquadImg src="/images/fathomSquad/squadRow.png" alt="fathom bunnies squad" />
        </Flex>
