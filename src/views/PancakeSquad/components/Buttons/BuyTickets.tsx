...
import { Button, useModal, useToast } from '@fathomswap/uikit'
...
import { FathomSquadContext } from 'views/FathomSquad/context'
...
const BuyTicketsButtons: React.FC<React.PropsWithChildren<BuyTicketsProps>> = ({
  ...
  const { isUserEnabled, setIsUserEnabled } = useContext(FathomSquadContext)
