...
import { getFathomSquadContract } from 'utils/contractHelpers'
  ...
  useEffect(() => {
    const fetchUserInfos = async () => {
      try {
        ...
        const fathomSquadContract = getFathomSquadContract()
        ...
        if (account) {
          ...
          const currentNumberTokensOfUser = await fathomSquadContract.balanceOf(account)
