...
import { Card, CardBody, CardHeader, Heading, Text, Flex, Link } from '@fathomswap/uikit'
        ...
        <StyledCardbody>
          ...
          <FoldableText title={t('Where can I learn more about this new Pottery format?')} mt="24px">
            <Text>
              ...
              <InlineLink fontSize="14px" external href="https://t.me/fathomswap">
                {t('Telegram')}
              </InlineLink>
              {t('or')}
              <InlineLink fontSize="14px" external href="https://discord.gg/fathomswap">
                {t('Discord')}
              </InlineLink>
              {t(
