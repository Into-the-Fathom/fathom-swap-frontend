import { Box, Message, MessageText } from '@fathomswap/uikit'
    ...
    <Message variant="warning">
      <Box>
        <MessageText>
          {notMeetRequired &&
            notMeetThreshold &&
            t('This pool requires active Fathom Profile and %amount% profile points.', {
              amount: profileRequirement.thresholdPoints.toNumber().toLocaleString(),
            })}
          {notMeetRequired && !notMeetThreshold && t('This pool requires active Fathom Profile')}
          {!notMeetRequired &&
            notMeetThreshold &&
