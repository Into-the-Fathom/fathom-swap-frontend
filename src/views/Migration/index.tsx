...
import { Heading, Text, Button, ArrowForwardIcon, Link } from '@fathomswap/uikit'
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.fathomswap.finance/code/migration/migrate-your-stakings" external>
