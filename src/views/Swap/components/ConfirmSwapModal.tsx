...
import { Trade, Currency, TradeType, CurrencyAmount } from '@fathomswap/sdk'
import { InjectedModalProps, LinkExternal, Text } from '@fathomswap/uikit'
...
const FathomRouterSlippageErrorMsg =
  'This transaction will not succeed either due to price movement or fee on transfer. Try increasing your slippage tolerance.'

const SwapTransactionErrorContent = ({ onDismiss, message, openSettingModal }) => {
  const isSlippagedErrorMsg = message?.includes(FathomRouterSlippageErrorMsg)
    ...
    <TransactionErrorContent
      message={
        <>
          ...
          <LinkExternal
            href="https://docs.fathomswap.finance/products/fathomswap-exchange/trade-guide"
