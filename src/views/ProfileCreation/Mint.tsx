...
import { Card, CardBody, Heading, Text, useToast } from '@fathomswap/uikit'
...
const Mint: React.FC<React.PropsWithChildren> = () => {
  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {t('You can change your profile pic later if you get another approved Fathom Collectible.')}
      </Text>
      <Card mb="24px">
        <CardBody>
