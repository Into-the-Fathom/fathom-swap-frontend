import { ArrowForwardIcon, Button, Text, Link, useMatchBreakpoints, useIsomorphicEffect } from '@fathomswap/uikit'
...
const PerpetualBanner = () => {
  ...
  const perpetualUrl = useMemo(
    () => `https://perp.fathomswap.finance/${perpLangMap(code)}/futures/BTCUSDT?theme=${perpTheme(isDark)}`,
    [code, isDark],
  )
