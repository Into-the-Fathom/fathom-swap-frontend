...
import { Button, CheckmarkIcon, CogIcon, Input, LinkExternal, Text, Toggle, useTooltip } from '@fathomswap/uikit'
  ...
  const sortedLists = useMemo(() => {
    ...
    return listUrls
      ...
      .sort((u1, u2) => {
        ...
        if (l1 && l2) {
          // Always make FathomSwap list in top.
          const keyword = 'fathomswap'
