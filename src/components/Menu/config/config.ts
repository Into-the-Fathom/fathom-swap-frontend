import {
  ...
  NftFillIcon,
  MoreIcon,
} from '@fathomswap/uikit'
import { ContextApi } from '@fathomswap/localization'
import { nftsBaseUrl } from 'views/Nft/market/constants'
import { perpLangMap } from 'utils/getPerpetualLanguageCode'
import { perpTheme } from 'utils/getPerpetualTheme'
import { DropdownMenuItems } from '@fathomswap/uikit/src/components/DropdownMenu/types'
    ...
    [
      {
        ...
        items: [
          ...
          {
            label: t('Perpetual'),
            href: `https://perp.fathomswap.finance/${perpLangMap(languageCode)}/futures/BTCUSDT?theme=${perpTheme(
              isDark,
            )}`,
          ...
          {
            label: t('Bridge'),
            href: 'https://bridge.fathomswap.finance/',
            type: DropdownMenuItemType.EXTERNAL_LINK,
          },
