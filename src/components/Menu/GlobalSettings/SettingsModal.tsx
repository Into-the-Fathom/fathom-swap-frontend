...
import { Text, FathomToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher, Box } from '@fathomswap/uikit'
import {
  useAudioModeManager,
          ...
          <>
            ...
            <Flex justifyContent="space-between" alignItems="center" mb="24px">
              <Flex alignItems="center">
                ...
                <QuestionHelper
                  text={t('Fun sounds to make a truly immersive fathom-flipping trading experience')}
                  placement="top-start"
                  ml="4px"
                />
              </Flex>
              <FathomToggle checked={audioPlay} onChange={toggleSetAudioMode} scale="md" />
            </Flex>
          </>
        )}
      </ScrollableContainer>
