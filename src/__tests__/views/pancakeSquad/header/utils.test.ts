import { ButtonsEnum } from 'views/FathomSquad/components/Header/types'
import { getCurrentButton } from 'views/FathomSquad/components/Header/utils'
import { SaleStatusEnum, UserStatusEnum } from 'views/FathomSquad/types'

describe('FathomSquad/Header/utils/getCurrentButton', () => {
