...
import { getAltText, getEventStepStatus, getEventText } from 'views/FathomSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('FathomSquad/utils/getEventStepStatus', () => {
...
describe('FathomSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('FathomSquad/utils/getAltText', () => {
