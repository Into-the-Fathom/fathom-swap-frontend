import { BuyButtonsEnum } from 'views/FathomSquad/components/Buttons/types'
import { getBuyButton, getBuyButtonText } from 'views/FathomSquad/components/Buttons/utils'
import { SaleStatusEnum } from 'views/FathomSquad/types'

describe('FathomSquad/buttons/utils/getBuyButtonText', () => {
...
describe('FathomSquad/buttons/utils/getBuyButton', () => {
