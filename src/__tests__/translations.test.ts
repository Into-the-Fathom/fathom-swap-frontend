...
const whitelist = [
  ...
  'Sunny is always cheerful when there are fathoms around. Smile!',
  ...
  'These bunnies love nothing more than swapping fathoms. Especially on BSC.',
  `It's raining syrup on this bunny, but he doesn't seem to mind. Can you blame him?`,
  `These bunnies like their fathoms with blueberries. What's your favorite topping?`,
  "Love makes the world go 'round... but so do fathoms. And these bunnies know it.",
  `It’s sparkling syrup, fathoms, and even lottery tickets! This bunny really loves it.`,
...
describe('Check translations available', () => {
  ...
  throughDirectory('node_modules/@fathomswap/uikit', true)
