...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, FathomDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | FathomDayData): ChartEntry => ({
