import { ChainId, Pair, Token } from '@fathomswap/sdk'
import { deserializeToken } from '@fathomswap/tokens'
import { differenceInDays } from 'date-fns'
import flatMap from 'lodash/flatMap'
import { getFarmConfig } from '@fathomswap/farms/constants'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Cake-LP', 'Fathom LPs')
}
