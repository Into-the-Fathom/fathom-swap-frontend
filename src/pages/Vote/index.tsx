            ...
            <AutoColumn gap="md">
              ...
              <RowBetween>
                <TYPE.white fontSize={14}>
                  UNI tokens represent voting shares in FathomSwap governance. You can vote on each proposal yourself or
                  delegate your votes to a third party.
                </TYPE.white>
              </RowBetween>
              <ExternalLink
                style={{ color: 'white', textDecoration: 'underline' }}
                href="https://fathomswap.org/blog/uni"
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about FathomSwap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
