...
import { FTHM, ZERO_ADDRESS } from 'constants/index'
import { ChainId, JSBI, TokenAmount } from 'fathomswap-sdk'
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Fathomswap Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  FTHM tokens represent voting shares in Uniswap governance. You can vote on each proposal yourself or
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Fatomswap governance</TYPE.white>
              </ExternalLink>
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TopSection gap="2px">
        <WrapSmall>
          ...
          {showUnlockVoting ? (
            ...
            JSBI.notEqual(JSBI.BigInt(0), fthmBalance?.raw) ? (
            <TYPE.body fontWeight={500} mr="6px">
              <FormattedCurrencyAmount currencyAmount={fthmBalance} /> Votes
            </TYPE.body>
          ) : (
            ''
          )}
          ...
          <RowBetween>
            ...
            {userDelegatee && userDelegatee !== ZERO_ADDRESS ? (
              <RowFixed>
                ...
                <AddressButton>
                  <StyledExternalLink
                    href={getEtherscanLink(ChainId.XDC, userDelegatee, 'address')}
                    style={{ margin: '0 4px' }}
                  >
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total FTHM supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
