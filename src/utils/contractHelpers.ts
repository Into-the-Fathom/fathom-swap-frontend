...
import { CAKE } from '@fathomswap/tokens'

// Addresses
import {
  getAddress,
  getFathomProfileAddress,
  getFathomBunniesAddress,
...
import fathomBunniesAbi from 'config/abi/fathomBunnies.json'
...
import fathomSquadAbi from 'config/abi/fathomSquad.json'
...
export const getProfileContract = (signer?: Signer | Provider) => {
  return getContract({ abi: profileABI, address: getFathomProfileAddress(), signer }) as FathomProfile
}
export const getFathomBunniesContract = (signer?: Signer | Provider) => {
  return getContract({ abi: fathomBunniesAbi, address: getFathomBunniesAddress(), signer }) as FathomBunnies
}
...
export const getFathomSquadContract = (signer?: Signer | Provider) => {
  return getContract({ abi: fathomSquadAbi, address: getFathomSquadAddress(), signer }) as FathomSquad
}
