import { Currency, CurrencyAmount, Fraction, JSBI, Percent, Trade, TradeType } from '@fathomswap/sdk'
import IFathomRouter02ABI from 'config/abi/IFathomRouter02.json'
import { IFathomRouter02 } from 'config/abi/types/IFathomRouter02'
import {
...
export function useRouterContract() {
  ...
  return useContract<IFathomRouter02>(ROUTER_ADDRESS[chainId], IFathomRouter02ABI, true)
}
