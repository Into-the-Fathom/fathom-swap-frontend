import { BinanceWalletConnector } from '@fathomswap/wagmi/connectors/binanceWallet'
import { bsc, bscTest, goerli, rinkeby } from '@fathomswap/wagmi/chains'
...
export const coinbaseConnector = new CoinbaseWalletConnector({
  ...
  options: {
    appName: 'FathomSwap',
    appLogoUrl: 'https://fathomswap.com/logo.png',
  },
})
