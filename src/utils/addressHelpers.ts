...
export const getFathomProfileAddress = () => {
  return getAddress(addresses.fathomProfile)
}
export const getFathomBunniesAddress = () => {
  return getAddress(addresses.fathomBunnies)
}
...
export const getFathomSquadAddress = () => {
  return getAddress(addresses.fathomSquad)
}
