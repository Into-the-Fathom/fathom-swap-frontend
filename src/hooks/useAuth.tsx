...
import { Box, connectorLocalStorageKey, LinkExternal, Text, useToast } from '@fathomswap/uikit'
        ...
        if (error instanceof ConnectorNotFoundError) {
          toastError(
            ...
            <Box>
              ...
              <LinkExternal href="https://docs.fathomswap.finance/get-started/connection-guide">
                {t('Need help ?')}
              </LinkExternal>
            </Box>,
          )
