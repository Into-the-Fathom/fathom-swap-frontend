import { CurrencyAmount, Token } from '@fathomswap/sdk'
import {
  BlockIcon,
  Box,
  Button,
...
export function Menu() {
  ...
  return (
    <Flex height="56px" bg="backgroundAlt" px="16px" alignItems="center" justifyContent="space-between" zIndex={9}>
      <Flex>
        <Logo isDark={theme.isDark} href="https://fathomswap.finance" />
        ...
        <Flex pl={['25px', null, '50px']}>
          ...
          <StyledMenuItem href="https://fathomswap.finance/swap">Swap</StyledMenuItem>
        </Flex>
      </Flex>
