...
it("renders ConnectModal correctly", () => {
  const { asFragment } = renderWithProvider(<ConnectModal login={noop} t={(key: string) => key} />);
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled) {
      opacity: 0.85;
    ...
    .c15:hover:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c15:active:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c22:hover:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c22:active:not(:disabled):not(.fathom-button--disabled):not(.fathom-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              class="c22"
              href="https://docs.fathomswap.finance/get-started/connection-guide"
