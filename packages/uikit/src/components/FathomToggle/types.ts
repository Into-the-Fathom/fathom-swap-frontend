...
export interface FathomToggleProps extends InputHTMLAttributes<HTMLInputElement> {
  scale?: Scales;
  checked?: boolean;
}
...
export const scaleKeys = {
  fathomSize: "fathomSize",
  travelDistance: "travelDistance",
  toggleHeight: "toggleHeight",
  toggleWidth: "toggleWidth",
  fathomThickness: "fathomThickness",
  fathomTwoOffset: "fathomTwoOffset",
  fathomThreeOffset: "fathomThreeOffset",
  butterTop: "butterTop",
