/**
 * @see https://github.com/fathomswap/fathom-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://fathomswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://fathombunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
